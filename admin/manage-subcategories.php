...
if (strlen($_SESSION['login']) == 0) {
    ...
    if ($_GET['resid']) {
        ...
        $msg = "Kategori telah berhaasil dikembalikan";
    }
...
?>
    ...
    <head>
        ...
        <title>Administrator | Manage SubKategori</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Manage SubKategori</h4>
                                    ...
                                    <div class="demo-box m-t-20">
                                        <div class="m-b-30">
                                            <a href="add-subcategory.php">
                                                <button id="addToTable" class="btn btn-success waves-effect waves-light">Tambah Sub-Kategori <i class="mdi mdi-plus-circle-outline"></i></button>
                                            </a>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="demo-box m-t-20">
                                        <div class="m-b-30">
                                            ...
                                            <h4><i class="fa fa-trash-o"></i>Sub-Kategori yang dihapus</h4>
