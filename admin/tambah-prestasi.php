            ...
            <div class="col-md-8 mx-auto">
              <div class="card-box">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="tambah-prestasi-act.php" enctype="multipart/form-data">

                    <div class="m-b-20">
                      <label for="exampleFormControlInput1" class="form-label">NIS</label>
                      <input type="text" name="t_nis" class="form-control" placeholder="Masukkan NIS Siswa">
                    </div>

                    <div class="m-b-20">
                      <label for="exampleFormControlInput1" class="form-label">Nama</label>
                      <input type="text" name="t_nama" class="form-control" placeholder="Masukkan Nama Siswa">
                    </div>

                    <div class="m-b-20">
                      <label for="exampleFormControlInput1" class="form-label">Kategori</label>
                      <input type="text" name="t_kategori" class="form-control" placeholder="Masukkan Kategori Prestasi" required>
                    </div>

                    <div class="m-b-20">
                      <label for="exampleFormControlTextarea1" class="form-label">Deskripsi</label>
                      <textarea name="t_deskripsi" class="summernote" placeholder="Masukkan deskripsi singkat" rows="3" required></textarea>
                    </div>

                    <div class=" m-b-20">
                      <label for="exampleFormControlTextarea1" class="form-label">Kelas</label>
                      <select name="t_kelas" class="form-control">
                        <option></option>
