...
?>
    ...
    <head>
        ...
        <title>Administrator | Manage Kategori</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Manage Komentar Tidak Disetujui</h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($st == '0') : ?>
                                                                    <a href="unapprove-comment.php?disid=<?php echo htmlentities($row['id']); ?>" title="Nonaktifkan komentar ini"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a>
                                                                <?php else : ?>
                                                                    <a href="unapprove-comment.php?appid=<?php echo htmlentities($row['id']); ?>" title="Setujui komentar ini"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a>
                                                                <?php endif; ?>
