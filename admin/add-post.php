...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            echo "<script>alert('Ekstensi tidak diperbolehkan. Hanya ekstensi jpg / jpeg/ png /gif yang diperbolehkan');</script>";
        } else {
                                ...
                                <div class="p-6">
                                    <div class="">
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            ...
                                            <button type="button" class="btn btn-danger waves-effect waves-light">Batalkan</button>
                                        </form>
                                    </div>
                                </div> <!-- end p-20 -->
                            </div> <!-- end col -->
