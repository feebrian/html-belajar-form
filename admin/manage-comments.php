...
?>
    ...
    <head>
        ...
        <title>Administrator | Manage Komentar</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Manage Komentar disetujui</h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($st == 0) : ?>
                                                                    <a href="manage-comments.php?disid=<?php echo htmlentities($row['id']); ?>" title="Nonaktifkan Komentar ini"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a>
                                                                <?php else : ?>
